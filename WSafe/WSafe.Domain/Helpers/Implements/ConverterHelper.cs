...
namespace WSafe.Domain.Helpers.Implements
{
    public class ConverterHelper : IConverterHelper
    {
        ...
        public PlanActivity ToPlanActivityAsync(CreatePlanActivityVM model, bool isNew)
        {
        ...
        public Occupational ToOccupationalAsync(CreateOccupationalVM model, bool isNew)
        {
        ...
        public Capacitation ToCapacitationAsync(CreateCapacitationVM model, bool isNew)
        {
